---
title: "MAIT_dataset_Ng_Turiello"
...
if(long.compute){
  ...
  #devtools::install_github("satijalab/seurat-object", ref = "89bf440")
  
  
  list.files("./data/MAIT_dataset/")
  MAIT.seurat <- readRDS("data/MAIT_dataset/GSE182239_MAIT_SeuratObj_Aug2021.rds")
  
  MAIT.seurat <- SeuratObject::UpdateSeuratObject(MAIT.seurat)
  MAIT.seurat@meta.data
  DefaultAssay(MAIT.seurat) <- "RNA"
  
    MAIT.metadata <- readRDS("data/MAIT_dataset/GSE182239_MAIT_cell_metadata.rds")

AddMetaData(MAIT.seurat, metadata = MAIT.metadata$donor)
    DimPlot(MAIT.seurat, group.by = "res.0.1")
