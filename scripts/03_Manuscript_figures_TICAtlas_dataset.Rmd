...
# Figure X
p1 <- scCustomize::DimPlot_scCustom(TICAtlas, 
                                  reduction = "umap",
                                  group.by = "cell_type",
                                  label = TRUE, 
                                  label.size = 3, 
...
ggsave(plot = p1, 
       filename = paste0(output.dir, "Figure_X_UMAP_annotations_celltype_TICAtlas_withlegend.pdf"),
       device = "pdf", )

ggsave(plot = p1 + NoLegend(), 
       filename = paste0(output.dir, "Figure_X_UMAP_annotations_celltype_TICAtlas.pdf"),
       device = "pdf", )

# Figure X
p1 <- scCustomize::Plot_Density_Custom(TICAtlas,
                                 features = "NKG7",
                                 custom_palette = batlow.pal,
                                 reduction = "umap", 
                                 pt.size = 1) + 
...
ggsave(plot = p1, 
       filename = paste0(output.dir, "Figure_X_UMAP_DensityPlot_NKG7_TICAtlas.pdf"),
       device = "pdf", )
...
dev.copy(pdf, paste0(output.dir, "Figure_X_VlnPlot_NKG7_ordered_TICatlas.pdf"))
dev.off()
